...
use Hail\Flysystem\Adapter\Polyfill\NotSupportingVisibilityTrait;
use Hail\Flysystem\Adapter\Polyfill\StreamedCopyTrait;
use Hail\Flysystem\Adapter\Polyfill\StreamedWritingTrait;
...
class Zip extends AbstractAdapter
{
	...
	public function write($path, $contents, array $config)
	{
		...
		if ($config && isset($config['visibility'])) {
