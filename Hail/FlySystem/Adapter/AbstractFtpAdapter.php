...
namespace Hail\Flysystem\Adapter;

use DateTime;
use Hail\Flysystem\AdapterInterface;
use Hail\Flysystem\Exception\NotSupportedException;
use Hail\Flysystem\Util\SafeStorage;
...
abstract class AbstractFtpAdapter extends AbstractAdapter
{
	...
	{
		return $this->safeStorage->get('username') ?? 'anonymous';
	}
	...
	{
		$this->safeStorage->set('username', $username);
	...
	{
		return $permissions[0] === 'd' ? 'dir' : 'file';
	}
