...
class Engine extends Object
{
	...
	private $filters = array(
		NULL => array(), // dynamic
		'bytes' => 'Hail\Latte\Runtime\Filters::bytes',
		'capitalize' => 'Hail\Latte\Runtime\Filters::capitalize',
		'datastream' => 'Hail\Latte\Runtime\Filters::dataStream',
		'date' => 'Hail\Latte\Runtime\Filters::date',
		'escapecss' => 'Hail\Latte\Runtime\Filters::escapeCss',
		'escapehtml' => 'Hail\Latte\Runtime\Filters::escapeHtml',
		'escapehtmlcomment' => 'Hail\Latte\Runtime\Filters::escapeHtmlComment',
		'escapeical' => 'Hail\Latte\Runtime\Filters::escapeICal',
		'escapejs' => 'Hail\Latte\Runtime\Filters::escapeJs',
		'escapeurl' => 'rawurlencode',
		'escapexml' => 'Hail\Latte\Runtime\Filters::escapeXML',
		'firstupper' => 'Hail\Latte\Runtime\Filters::firstUpper',
		'implode' => 'implode',
		'indent' => 'Hail\Latte\Runtime\Filters::indent',
		'lower' => 'Hail\Latte\Runtime\Filters::lower',
		'nl2br' => 'Hail\Latte\Runtime\Filters::nl2br',
		'number' => 'number_format',
		'repeat' => 'str_repeat',
		'replace' => 'Hail\Latte\Runtime\Filters::replace',
		'replacere' => 'Hail\Latte\Runtime\Filters::replaceRe',
		'safeurl' => 'Hail\Latte\Runtime\Filters::safeUrl',
		'strip' => 'Hail\Latte\Runtime\Filters::strip',
		'striptags' => 'strip_tags',
		'substr' => 'Hail\Latte\Runtime\Filters::substring',
		'trim' => 'Hail\Latte\Runtime\Filters::trim',
		'truncate' => 'Hail\Latte\Runtime\Filters::truncate',
		'upper' => 'Hail\Latte\Runtime\Filters::upper',
	...
	public function __construct($dir)
	{
		if (is_array($dir)) {
			if (isset($dir['directory'])) {
				$this->templateDirectory = $dir['directory'];
			}

			if (isset($dir['cache'])) {
				$this->tempDirectory = $dir['cache'];
			}
	...
	{
		if (!$this->loader) {
			$this->loader = new Loaders\FileLoader($this->templateDirectory);
		}
		return $this->loader;
	}
