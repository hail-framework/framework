...
/**
 * Class WebDAV
 * $ composer require sabre/dav:~3.1
 *
...
class WebDAV extends AbstractAdapter
{
	...
	public function __construct(array $config)
	{
		...
		$this->setUseStreamedCopy($config['useStreamedCopy'] ?? true);
	}
	...
	{
		if (!$this->createDir(Util::dirname($newPath), [])) {
			return false;
		}
	...
	{
		if (!isset($object['{DAV:}getcontentlength']) || $object['{DAV:}getcontentlength'] === '') {
