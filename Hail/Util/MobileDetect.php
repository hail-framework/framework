...
class MobileDetect
{
	...
	public function setCfHeaders($cfHeaders = null)
	{
		...
		foreach ($cfHeaders as $key => $value) {
			if (stripos($key, 'http_cloudfront_') === 0) {
	...
	public function mobileGrade()
	{
		...
		if (
			...
			(
				($isAndroidOS = $this->is('AndroidOS')) && (
					// Chrome for Android - Tested on Android 4.0, 4.1 device
					($this->is('Chrome') && $this->version('Android', self::VERSION_TYPE_FLOAT) >= 4.0) ||

					// Skyfire 4.1 - Tested on Android 2.3 device
					($this->is('Skyfire') && $this->version('Skyfire', self::VERSION_TYPE_FLOAT) >= 4.1 && $this->version('Android', self::VERSION_TYPE_FLOAT) >= 2.3) ||

					// Opera Mobile 11.5-12: Tested on Android 2.3
					($this->is('Opera') && $this->version('Opera Mobi', self::VERSION_TYPE_FLOAT) >= 11.5)
				)
			) ||
			...
			($isAndroidOS && $this->is('NookTablet')) ||
