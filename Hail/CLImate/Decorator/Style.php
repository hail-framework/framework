...
namespace Hail\CLImate\Decorator;

use Hail\CLImate\Decorator\Parser\ParserFactory;
...
class Style
{
    ...
    public function __construct()
    {
        foreach ($this->available as $key => $class) {
            $class = 'Hail\CLImate\Decorator\Component\\' . $class;
     ...
     *
     * @param \Hail\CLImate\Util\System\System $system
     *
