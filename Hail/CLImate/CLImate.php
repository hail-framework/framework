...
namespace Hail\CLImate;

use Hail\CLImate\Argument\Manager as ArgumentManager;
use Hail\CLImate\Decorator\Style;
use Hail\CLImate\Settings\Manager as SettingsManager;
use Hail\CLImate\TerminalObject\Router\Router;
use Hail\CLImate\Util\Helper;
use Hail\CLImate\Util\Output;
use Hail\CLImate\Util\UtilFactory;
...
class CLImate
{
     ...
     *
     * @var \Hail\CLImate\Decorator\Style $style
     */
    public $style;
     ...
     *
     * @var \Hail\CLImate\TerminalObject\Router\Router $router
     */
    protected $router;
     ...
     *
     * @var \Hail\CLImate\Argument\Manager $arguments
     */
    public $arguments;
     ...
     *
     * @param \Hail\CLImate\Decorator\Style $style
     */
     ...
     *
     * @param \Hail\CLImate\TerminalObject\Router\Router $router
     */
     ...
     *
     * @param \Hail\CLImate\Settings\Manager $manager
     */
     ...
     *
     * @param \Hail\CLImate\Argument\Manager $manager
     */
     ...
     *
     * @param \Hail\CLImate\Util\Output $output
     */
     ...
     *
     * @param \Hail\CLImate\Util\UtilFactory $util
     */
     ...
     * @param array  $arguments
     *
     * @return \Hail\CLImate\CLImate|\Hail\CLImate\TerminalObject\Dynamic\DynamicTerminalObject
     *
