<?php
namespace Hail\Console\Argument;

use Hail\Console\Console;
...
class Manager
{
	 ...
	 *
	 * @var \Hail\Console\Argument\Filter $filter
	 */
	protected $filter;
	/**
	 * Summary builder class
	 *
	 * @var \Hail\Console\Argument\Summary $summary
	 */
	protected $summary;
	 ...
	 *
	 * @var \Hail\Console\Argument\Parser $parser
	 */
	protected $parser;
	 ...
	 * @param array   $argv
	 */
	public function usage(Console $console, array $argv = null)
	{
		$this->summary
			->setClimate($console)
