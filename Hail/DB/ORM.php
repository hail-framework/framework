 ...
 */
abstract class ORM extends Base
{
	/**
	 ...
	 * @return ORM return $this, can using chain method calls.
	 */
	 ...
	 * @return bool|ORM if find record, assign in to current object and return it, other wise return "false".
	 */
	 ...
	 * @return bool|ORM if update success return current object, other wise return false.
	 */
	 ...
	 * @return bool|ORM if insert success return current object, other wise return false.
	 */
	 ...
	 * @param ORM $obj The object, if find record in database, will assign the attributes in to this object.
	 * @return bool
	 */
	...
	{
		return self::callbackQuery('ORM::_queryCallback', $sql, $param, $obj);
	}
	 ...
	 * @param array $param The param will be bind to PDOStatement.
	 * @param ORM $obj The object, if find record in database, will assign the attributes in to this object.
	 * @return mixed if success to exec SQL, return array of ORM object, other wise return false.
	 */
	public static function queryAll($sql, $param = array(), $obj = null)
	{
		return self::callbackQuery('ORM::_queryAllCallback', $sql, $param, $obj);
	}
	...
	protected function & getRelation($name)
	{
		...
		else throw new \RuntimeException("Relation $name not found.");
	 ...
	 * @param ORM $o The refrence to $this
	 * @return string
	 */
	...
	public function __call($name, $args)
	{
		...
		else throw new \RuntimeException("Method $name not exist.");
		return $this;
	}
