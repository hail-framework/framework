...
use Hail\Excel\Writer\Exception\SheetNotFoundException;
...
abstract class AbstractWorkbook implements WorkbookInterface
{
    ...
    /**
     * @return \Hail\Excel\Writer\Common\Helper\AbstractStyleHelper The specific style helper
     */
     ...
     * The writing will resume where it stopped (i.e. data won't be truncated).
     *
     * @param \Hail\Excel\Writer\Common\Sheet $sheet The "external" sheet to set as current
     * @return void
     * @throws \Hail\Excel\Writer\Exception\SheetNotFoundException If the given sheet does not exist in the workbook
     */
     ...
     *
     * @param \Hail\Excel\Writer\Common\Sheet $sheet
     ...
     * @param \Hail\Excel\Writer\Style\Style $style Style to be applied to the row.
     * @return void
     * @throws \Hail\Excel\Common\Exception\IOException If trying to create a new sheet and unable to open the sheet for writing
     * @throws \Hail\Excel\Writer\Exception\WriterException If unable to write data
     */
