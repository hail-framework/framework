...
namespace Hail\Excel\Writer\XLSX;

use Hail\Excel\Writer\AbstractMultiSheetsWriter;
use Hail\Excel\Writer\Style\StyleBuilder;
use Hail\Excel\Writer\XLSX\Internal\Workbook;

/**
 * Class Writer
 * This class provides base support to write data to XLSX files
 *
 * @package Hail\Excel\Writer\XLSX
 */
class Writer extends AbstractMultiSheetsWriter
{
     ...
     * @return Writer
     * @throws \Hail\Excel\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened
     */
     ...
     *
     * @return void
     * @throws \Hail\Excel\Common\Exception\IOException If unable to open the file for writing
     */
     ...
     * @return void
     * @throws \Hail\Excel\Writer\Exception\WriterNotOpenedException If the book is not created yet
