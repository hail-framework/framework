...
namespace Hail\Excel\Writer\XLSX\Helper;

use Hail\Excel\Writer\Common\Helper\ZipHelper;
use Hail\Excel\Writer\XLSX\Internal\Worksheet;
 ...
 *
 * @package Hail\Excel\Writer\XLSX\Helper
 */
class FileSystemHelper extends \Hail\Excel\Common\Helper\FileSystemHelper
{
    const APP_NAME = 'Excel';
     ...
     * @throws \Hail\Excel\Common\Exception\IOException If unable to create the folder
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Excel\Common\Exception\IOException If unable to create the folder or the ".rels" file
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Excel\Common\Exception\IOException If unable to create the file
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Excel\Common\Exception\IOException If unable to create the folder or one of the files
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Excel\Common\Exception\IOException If unable to create at least one of the folders
     */
