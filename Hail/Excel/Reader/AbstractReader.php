...
use Hail\Excel\Reader\Exception\ReaderNotOpenedException;
...
abstract class AbstractReader implements ReaderInterface
{
	...
	/** @var \Hail\Excel\Reader\Common\ReaderOptions Reader's customized options */
    protected $options;

	/**
     * Returns the reader's current options
     *
     * @return \Hail\Excel\Reader\Common\ReaderOptions
     */
     ...
     * @param  string $filePath Path of the file to be read
     * @return void
     * @throws \Hail\Excel\Common\Exception\IOException If the file at the given path does not exist, is not readable or is corrupted
     */
    ...
    protected function isSupportedStreamWrapper($filePath)
    {
        ...
        return ($streamScheme !== null) ?
            in_array($streamScheme, stream_get_wrappers()) :
            true;
    }
     ...
     * @api
     * @return \Iterator To iterate over sheets
     * @throws \Hail\Excel\Reader\Exception\ReaderNotOpenedException If called before opening the reader
     */
