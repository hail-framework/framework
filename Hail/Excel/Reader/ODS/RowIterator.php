...
namespace Hail\Excel\Reader\ODS;

use Hail\Excel\Common\Exception\IOException;
use Hail\Excel\Reader\Exception\IteratorNotRewindableException;
use Hail\Excel\Reader\Exception\XMLProcessingException;
use Hail\Excel\Reader\IteratorInterface;
use Hail\Excel\Reader\ODS\Helper\CellValueFormatter;
...
class RowIterator implements IteratorInterface
{
     ...
     *
     * @return void
     * @throws \Hail\Excel\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     */
	...
	/**
     * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-row>" starting node
    ...
    /**
     * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
