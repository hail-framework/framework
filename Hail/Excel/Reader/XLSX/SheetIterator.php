...
use Hail\Excel\Reader\XLSX\Helper\SheetHelper;
use Hail\Excel\Reader\Exception\NoSheetsFoundException;
...
{
    /** @var \Hail\Excel\Reader\XLSX\Sheet[] The list of sheet present in the file */
    protected $sheets;
     ...
     * @param \Hail\Excel\Reader\XLSX\Helper\SharedStringsHelper $sharedStringsHelper
	...
	public function __construct($filePath, $options, $sharedStringsHelper)
    {
	    ...
	    $sheetHelper = new SheetHelper($filePath, $options, $sharedStringsHelper);
     ...
     *
     * @return \Hail\Excel\Reader\XLSX\Sheet
     */
