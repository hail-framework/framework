...
use Hail\Excel\Reader\XLSX\Helper\CellHelper;
use Hail\Excel\Reader\XLSX\Helper\CellValueFormatter;
use Hail\Excel\Reader\XLSX\Helper\StyleHelper;
use Hail\Excel\Reader\Common\XMLProcessor;
...
class RowIterator implements IteratorInterface
{
	...
	/** @var \Hail\Excel\Reader\Wrapper\XMLReader The XMLReader object that will help read sheet's XML data */
	protected $xmlReader;

	/** @var \Hail\Excel\Reader\Common\XMLProcessor Helper Object to process XML nodes */
	 ...
	 *
	 * @return void
	 * @throws \Hail\Excel\Common\Exception\IOException If the sheet data XML cannot be read
	 */
	 ...
	 *
	 * @return void
	 * @throws \Hail\Excel\Reader\Exception\SharedStringNotFoundException If a shared string was not found
	 * @throws \Hail\Excel\Common\Exception\IOException If unable to read the sheet data XML
	 */
	...
	/**
	 * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<dimension>" starting node
	 *
	...
	/**
	 * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" starting node
	 *
	 * @return int A return code that indicates what action should the processor take next
	 */
	...
	/**
	 * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<cell>" starting node
	 *
	 * @return int A return code that indicates what action should the processor take next
	 */
	...
	/**
	 * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" node
	 *
	 * @return int Row index
	 * @throws \Hail\Excel\Common\Exception\InvalidArgumentException When the given cell index is invalid
	 */
	...
	/**
	 * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<c>" node
	 *
