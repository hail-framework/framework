...
namespace Hail\Excel\Reader\Common;
 ...
 *
 * @package Hail\Excel\Reader\Common
 */
class XMLProcessor
{
	/* Node types */
	...
	/**
	 * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object
	 */
	 ...
	 *
	 * @return void
	 * @throws \Hail\Excel\Reader\Exception\XMLProcessingException
	 */
