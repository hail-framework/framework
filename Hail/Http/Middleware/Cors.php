...
class Cors implements MiddlewareInterface
{
	...
	/** Settings key */
	const KEY_SERVER_ORIGIN = 'ORIGIN';
	const KEY_ALLOWED_ORIGINS = 'ALLOWED_ORIGINS';
	const KEY_ALLOWED_METHODS = 'ALLOWED_METHODS';
	const KEY_ALLOWED_HEADERS = 'ALLOWED_HEADERS';
	const KEY_EXPOSED_HEADERS = 'EXPOSED_HEADERS';
	const KEY_IS_USING_CREDENTIALS = 'CREDENTIALS';
	const KEY_FLIGHT_CACHE_MAX_AGE = 'CACHE_MAX_AGE';
	const KEY_IS_FORCE_ADD_METHODS = 'ADD_METHODS';
	const KEY_IS_FORCE_ADD_HEADERS = 'ADD_HEADERS';
	const KEY_IS_CHECK_HOST = 'CHECK_HOST';
