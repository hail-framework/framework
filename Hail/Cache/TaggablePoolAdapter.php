 ...
 */
class TaggablePoolAdapter implements TaggablePoolInterface
{
    ...
    {
        return TaggableItemAdapter::makeTaggable($this->cachePool->getItem($key));
    }
    ...
    public function getItems(array $keys = [])
    {
        ...
        foreach ($items as $key => $item) {
            $wrappedItems[$key] = TaggableItemAdapter::makeTaggable($item);
        }
