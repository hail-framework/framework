...
namespace Hail\Spout\Reader\XLSX\Helper;

use Hail\Spout\Common\Exception\IOException;
use Hail\Spout\Reader\Exception\XMLProcessingException;
use Hail\Spout\Reader\Wrapper\SimpleXMLElement;
use Hail\Spout\Reader\Wrapper\XMLReader;
use Hail\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyFactory;
use Hail\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyInterface;

/**
 * Class SharedStringsHelper
 * This class provides helper functions for reading sharedStrings XML file
 *
 * @package Hail\Spout\Reader\XLSX\Helper
 */
class SharedStringsHelper
{
     ...
     *
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If sharedStrings.xml can't be read
     */
    public function extractSharedStrings()
    {
        ...
        $escaper = \Hail\Spout\Common\Escaper\XLSX::getInstance();
     ...
     *
     * @param \Hail\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader instance
     * @return int|null Number of unique shared strings in the sharedStrings.xml file
     * @throws \Hail\Spout\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     */
     ...
     *
     * @param \Hail\Spout\Reader\Wrapper\XMLReader $xmlReader
     * @return \Hail\Spout\Reader\Wrapper\SimpleXMLElement
     * @throws \Hail\Spout\Common\Exception\IOException If the current node cannot be read
     */
     ...
     *
     * @param \Hail\Spout\Reader\Wrapper\SimpleXMLElement $parentNode Parent node that may contain nodes to remove
     * @return \Hail\Spout\Reader\Wrapper\SimpleXMLElement Cleaned parent node
     */
     ...
     *
     * @param \Hail\Spout\Reader\Wrapper\SimpleXMLElement $textNode The text node element (<t>) whitespace may be preserved
     ...
     * @throws \Hail\Spout\Reader\Exception\SharedStringNotFoundException If no shared string found for the given index
     */
