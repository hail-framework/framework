...
namespace Hail\Spout\Reader\XLSX\Helper\SharedStringsCaching;

use Hail\Spout\Common\Helper\FileSystemHelper;
use Hail\Spout\Common\Helper\GlobalFunctionsHelper;
use Hail\Spout\Reader\Exception\SharedStringNotFoundException;
 ...
 *
 * @package Hail\Spout\Reader\XLSX\Helper\SharedStringsCaching
 */
class FileBasedStrategy implements CachingStrategyInterface
{
    ...
    /** @var \Hail\Spout\Common\Helper\FileSystemHelper Helper to perform file system operations */
