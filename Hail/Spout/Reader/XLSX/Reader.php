...
use Hail\Spout\Reader\AbstractReader;
use Hail\Spout\Reader\XLSX\Helper\SharedStringsHelper;
...
class Reader extends AbstractReader
{
     ...
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If the file at the given path or its content cannot be read
