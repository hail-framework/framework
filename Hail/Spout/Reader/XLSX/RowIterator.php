...
namespace Hail\Spout\Reader\XLSX;
...
use Hail\Spout\Reader\XLSX\Helper\CellHelper;
use Hail\Spout\Reader\XLSX\Helper\CellValueFormatter;
use Hail\Spout\Reader\XLSX\Helper\StyleHelper;

/**
 * Class RowIterator
 *
 * @package Hail\Spout\Reader\XLSX
 */
class RowIterator implements IteratorInterface
{
    ...
    /** @var \Hail\Spout\Reader\Wrapper\XMLReader The XMLReader object that will help read sheet's XML data */
    protected $xmlReader;
     ...
     *
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If the sheet data XML cannot be read
     */
     ...
     *
     * @return void
     * @throws \Hail\Spout\Reader\Exception\SharedStringNotFoundException If a shared string was not found
     * @throws \Hail\Spout\Common\Exception\IOException If unable to read the sheet data XML
     */
    ...
    /**
     * @param \Hail\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<c>" tag
     * @return int
     * @throws \Hail\Spout\Common\Exception\InvalidArgumentException When the given cell index is invalid
     */
