...
use Hail\Spout\Reader\Exception\ReaderNotOpenedException;
...
abstract class AbstractReader implements ReaderInterface
{
     ...
     * @param  string $filePath Path of the file to be read
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If the file at the given path does not exist, is not readable or is corrupted
     */
     ...
     * @api
     * @return \Iterator To iterate over sheets
     * @throws \Hail\Spout\Reader\Exception\ReaderNotOpenedException If called before opening the reader
     */
