...
namespace Hail\Spout\Reader\Wrapper;
 ...
 *
 * @package Hail\Spout\Reader\Wrapper
 */
class SimpleXMLElement
{
     ...
     * @throws \Hail\Spout\Reader\Exception\XMLProcessingException If the XML string is not well-formed
     */
