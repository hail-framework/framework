...
use Hail\Spout\Reader\Exception\IteratorNotRewindableException;
use Hail\Spout\Reader\Exception\XMLProcessingException;
use Hail\Spout\Reader\IteratorInterface;
use Hail\Spout\Reader\ODS\Helper\CellValueFormatter;
...
class RowIterator implements IteratorInterface
{
     ...
     *
     * @return void
     * @throws \Hail\Spout\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     */
