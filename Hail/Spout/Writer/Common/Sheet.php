...
namespace Hail\Spout\Writer\Common;

use Hail\Spout\Common\Helper\StringHelper;
use Hail\Spout\Writer\Exception\InvalidSheetNameException;
...
class Sheet
{
    ...
    /** @var \Hail\Spout\Common\Helper\StringHelper */
     ...
     * @return Sheet
     * @throws \Hail\Spout\Writer\Exception\InvalidSheetNameException If the sheet's name is invalid.
     */
