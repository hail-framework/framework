...
namespace Hail\Spout\Writer\Common\Helper;

/**
 * Class AbstractStyleHelper
 * This class provides helper functions to manage styles
 *
 * @package Hail\Spout\Writer\Common\Helper
 */
abstract class AbstractStyleHelper
{
    ...
    /**
     * @param \Hail\Spout\Writer\Style\Style $defaultStyle
     */
     ...
     *
     * @param \Hail\Spout\Writer\Style\Style $style The style to be registered
     * @return \Hail\Spout\Writer\Style\Style The registered style, updated with an internal ID.
     */
     ...
     *
     * @param \Hail\Spout\Writer\Style\Style $style
     * @return bool
     */
     ...
     * @return \Hail\Spout\Writer\Style\Style
     */
    ...
    /**
     * @return \Hail\Spout\Writer\Style\Style[] List of registered styles
     */
     ...
     *
     * @return \Hail\Spout\Writer\Style\Style Default style
     */
     ...
     *
     * @param \Hail\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \Hail\Spout\Writer\Style\Style The updated style
     */
     ...
     * @param \Hail\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \Hail\Spout\Writer\Style\Style The eventually updated style
     */
