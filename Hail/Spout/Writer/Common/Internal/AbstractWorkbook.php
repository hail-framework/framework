...
use Hail\Spout\Writer\Exception\SheetNotFoundException;
 ...
 *
 * @package Hail\Spout\Writer\Common
 */
abstract class AbstractWorkbook implements WorkbookInterface
{
     ...
     * @param \Hail\Spout\Writer\Style\Style $defaultRowStyle
     * @throws \Hail\Spout\Common\Exception\IOException If unable to create at least one of the base folders
     */
    ...
    /**
     * @return \Hail\Spout\Writer\Common\Helper\AbstractStyleHelper The specific style helper
     */
     ...
     * @throws \Hail\Spout\Common\Exception\IOException If unable to open the sheet for writing
     */
     ...
     * The writing will resume where it stopped (i.e. data won't be truncated).
     *
     * @param \Hail\Spout\Writer\Common\Sheet $sheet The "external" sheet to set as current
     * @return void
     * @throws \Hail\Spout\Writer\Exception\SheetNotFoundException If the given sheet does not exist in the workbook
     */
     ...
     *
     * @param \Hail\Spout\Writer\Common\Sheet $sheet
     ...
     * @param \Hail\Spout\Writer\Style\Style $style Style to be applied to the row.
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If trying to create a new sheet and unable to open the sheet for writing
     * @throws \Hail\Spout\Writer\Exception\WriterException If unable to write data
     */
