...
use Hail\Spout\Common\Exception\InvalidArgumentException;
use Hail\Spout\Writer\Exception\WriterAlreadyOpenedException;
use Hail\Spout\Writer\Exception\WriterNotOpenedException;
use Hail\Spout\Writer\Style\StyleBuilder;
...
abstract class AbstractWriter implements WriterInterface
{
    ...
    /** @var \Hail\Spout\Common\Helper\GlobalFunctionsHelper Helper to work with global functions */
     ...
     *
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If the writer cannot be opened
     */
     ...
     * @return AbstractWriter
     * @throws \Hail\Spout\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
     */
     ...
     *
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If the pointer is not available
     */
     ...
     * @return void
     * @throws \Hail\Spout\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened and must not be.
     */
     ...
     * @api
     * @return AbstractWriter
     * @throws \Hail\Spout\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
     * @throws \Hail\Spout\Common\Exception\IOException If unable to write data
     */
     ...
     * @return AbstractWriter
     * @throws \Hail\Spout\Common\Exception\InvalidArgumentException If the input param is not valid
     * @throws \Hail\Spout\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
     * @throws \Hail\Spout\Common\Exception\IOException If unable to write data
     */
