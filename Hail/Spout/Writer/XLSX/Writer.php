...
namespace Hail\Spout\Writer\XLSX;

use Hail\Spout\Writer\AbstractMultiSheetsWriter;
use Hail\Spout\Writer\Style\StyleBuilder;
use Hail\Spout\Writer\XLSX\Internal\Workbook;

/**
 * Class Writer
 * This class provides base support to write data to XLSX files
 *
 * @package Hail\Spout\Writer\XLSX
 */
class Writer extends AbstractMultiSheetsWriter
{
     ...
     * @return Writer
     * @throws \Hail\Spout\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened
     */
     ...
     *
     * @return void
     * @throws \Hail\Spout\Common\Exception\IOException If unable to open the file for writing
     */
     ...
     * @return void
     * @throws \Hail\Spout\Writer\Exception\WriterNotOpenedException If the book is not created yet
