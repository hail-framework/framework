...
namespace Hail\Spout\Writer\XLSX\Internal;

use Hail\Spout\Common\Exception\InvalidArgumentException;
use Hail\Spout\Common\Exception\IOException;
use Hail\Spout\Writer\Common\Helper\CellHelper;
use Hail\Spout\Writer\Common\Internal\WorksheetInterface;
 ...
 *
 * @package Hail\Spout\Writer\XLSX\Internal
 */
...
EOD;
    ...
    /** @var \Hail\Spout\Writer\Common\Sheet The "external" sheet */
    protected $externalSheet;

    /** @var string Path to the XML file that will contain the sheet data */
    protected $worksheetFilePath;

    /** @var \Hail\Spout\Writer\XLSX\Helper\SharedStringsHelper Helper to write shared strings */
    protected $sharedStringsHelper;

    /** @var \Hail\Spout\Writer\XLSX\Helper\StyleHelper Helper to work with styles */
    protected $styleHelper;

    /** @var bool Whether inline or shared strings should be used */
    protected $shouldUseInlineStrings;

    /** @var \Hail\Spout\Common\Escaper\XLSX Strings escaper */
    ...
    /**
     * @param \Hail\Spout\Writer\Common\Sheet $externalSheet The associated "external" sheet
     * @param string $worksheetFilesFolder Temporary folder where the files to create the XLSX will be stored
     * @param \Hail\Spout\Writer\XLSX\Helper\SharedStringsHelper $sharedStringsHelper Helper for shared strings
     * @param \Hail\Spout\Writer\XLSX\Helper\StyleHelper Helper to work with styles
     * @param bool $shouldUseInlineStrings Whether inline or shared strings should be used
     * @throws \Hail\Spout\Common\Exception\IOException If the sheet data file cannot be opened for writing
     */
    public function __construct($externalSheet, $worksheetFilesFolder, $sharedStringsHelper, $styleHelper, $shouldUseInlineStrings)
    {
        ...
        $this->stringsEscaper = \Hail\Spout\Common\Escaper\XLSX::getInstance();
