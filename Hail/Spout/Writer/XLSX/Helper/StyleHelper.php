...
use Hail\Spout\Writer\Common\Helper\AbstractStyleHelper;
use Hail\Spout\Writer\Style\Color;
use Hail\Spout\Writer\Style\Style;
...
EOD;
    ...
    protected function getFontsSectionContent()
    {
        ...
        /** @var \Hail\Spout\Writer\Style\Style $style */
        ...
        foreach ($this->registeredBorders as $styleId) {
            ...
            foreach ($sortOrder as $partName) {
                if ($border->hasPart($partName)) {
                    /** @var $part \Hail\Spout\Writer\Style\BorderPart */
