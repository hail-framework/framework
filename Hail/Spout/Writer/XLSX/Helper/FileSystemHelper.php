...
namespace Hail\Spout\Writer\XLSX\Helper;

use Hail\Spout\Writer\Common\Helper\ZipHelper;
use Hail\Spout\Writer\XLSX\Internal\Worksheet;
 ...
 *
 * @package Hail\Spout\Writer\XLSX\Helper
 */
class FileSystemHelper extends \Hail\Spout\Common\Helper\FileSystemHelper
{
     ...
     * @throws \Hail\Spout\Common\Exception\IOException If unable to create the folder
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Spout\Common\Exception\IOException If unable to create the folder or the ".rels" file
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Spout\Common\Exception\IOException If unable to create the file
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Spout\Common\Exception\IOException If unable to create the folder or one of the files
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Spout\Common\Exception\IOException If unable to create at least one of the folders
     */
