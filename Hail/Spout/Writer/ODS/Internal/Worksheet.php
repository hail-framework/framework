...
use Hail\Spout\Common\Helper\StringHelper;
...
class Worksheet implements WorksheetInterface
{
    ...
    /** @var \Hail\Spout\Common\Escaper\ODS Strings escaper */
    protected $stringsEscaper;

    /** @var \Hail\Spout\Common\Helper\StringHelper To help with string manipulation */
    ...
    public function __construct($externalSheet, $worksheetFilesFolder)
    {
        ...
        $this->stringsEscaper = \Hail\Spout\Common\Escaper\ODS::getInstance();
