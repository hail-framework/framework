...
namespace Hail\Spout\Writer\ODS\Helper;

use Hail\Spout\Writer\Common\Helper\ZipHelper;
use Hail\Spout\Writer\ODS\Internal\Worksheet;
 ...
 *
 * @package Hail\Spout\Writer\ODS\Helper
 */
class FileSystemHelper extends \Hail\Spout\Common\Helper\FileSystemHelper
{
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Spout\Common\Exception\IOException If unable to create the folder or the "manifest.xml" file
     */
