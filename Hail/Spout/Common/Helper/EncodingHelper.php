...
use Hail\Spout\Common\Exception\EncodingConversionException;
...
class EncodingHelper
{
	 ...
	 * @throws \Hail\Spout\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
	 */
