...
class SimpleCachePool implements CacheItemPoolInterface
{
    ...
    public function getItem($key)
    {
        ...
        try {
            ...
            throw $this->handleException($e, __FUNCTION__);
        }
    }
     ...
     *
     * @return \Psr\Cache\CacheException
     */
    private function handleException(\Exception $e, $function): CacheException
    {
