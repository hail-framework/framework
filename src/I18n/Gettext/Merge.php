...
class Merge
{
    ...
    public const HEADERS_ADD = 4;
    public const HEADERS_REMOVE = 8;
    public const HEADERS_OVERRIDE = 16;

    public const LANGUAGE_OVERRIDE = 32;
    public const DOMAIN_OVERRIDE = 64;
    public const TRANSLATION_OVERRIDE = 128;

    public const COMMENTS_OURS = 256;
    public const COMMENTS_THEIRS = 512;

    public const EXTRACTED_COMMENTS_OURS = 1024;
    public const EXTRACTED_COMMENTS_THEIRS = 2048;

    public const FLAGS_OURS = 4096;
    public const FLAGS_THEIRS = 8192;

    public const REFERENCES_OURS = 16384;
    public const REFERENCES_THEIRS = 32768;

    public const DEFAULTS = 5; //1 + 4
