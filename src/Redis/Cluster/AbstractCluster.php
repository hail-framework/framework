 ...
 */
abstract class AbstractCluster implements RedisInterface
{
    use RedisTrait;
    ...
    public function __construct($config)
    {
        if (empty($config['cluster'])) {
            throw new RedisException('Redis servers config not found');
        }

        $this->hosts = $config['cluster'];
