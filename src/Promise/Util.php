...
class Util
{
    ...
    public static function queue(TaskQueue $assign = null): TaskQueue
    {
        if ($assign) {
            static::$queue = $assign;
        } elseif (static::$queue === null) {
            static::$queue = new TaskQueue(!\defined('HAIL_SERVER_ENV'));
        }
     ...
     *
     * This promise is rejected with a {@see Hail\Promise\Exception\AggregateException}
