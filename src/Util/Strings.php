...
class Strings
{
     ...
     * @return string
     */
    public static function findPrefix($first, ...$strings): string
    {
        if (\is_array($first)) {
            $strings = $first;
            $first = $strings[0];
     ...
     * @throws RegexpException
     */
    public static function ltrim(string $s, string $charList = self::TRIM_CHARACTERS): string
    {
        $charList = \preg_quote($charList, '#');
     ...
     * @throws RegexpException
     */
    public static function rtrim(string $s, string $charList = self::TRIM_CHARACTERS): string
    {
        $charList = \preg_quote($charList, '#');
