...
class ChromeLogger implements LoggerInterface
{
    ...
    protected const COLUMN_BACKTRACE = 'backtrace';
    protected const COLUMN_TYPE = 'type';
    protected const CLASS_NAME = 'type';
    ...
    public const DATETIME_FORMAT = 'Y-m-d\\TH:i:s\\Z'; // ISO-8601 UTC date/time format
    public const LIMIT_WARNING = 'Beginning of log entries omitted - total header size over Chrome\'s internal limit!';
