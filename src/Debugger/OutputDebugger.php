...
class OutputDebugger
{
    ...
    private function renderHtml()
    {
        $res = '<!DOCTYPE HTML><html><head><style>'
            . 'code, pre {white-space:nowrap} a {text-decoration:none} pre {color:gray;display:inline} big {color:red}'
        ...
        foreach ($this->list as $item) {
            ...
            $res .= '<span title="' . Helpers::escapeHtml(\implode("\n", $stack)) . '">'
                ...
                . \str_replace(self::BOM, '<strong>BOM</strong>', Dumper::toHtml($item[2]))
                . "</span><br>\n";
        }

        return $res . '</code></body></html>';
    }
