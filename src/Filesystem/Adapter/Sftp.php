...
class Sftp extends AbstractFtpAdapter
{
    ...
    {
        $this->port = 22;
        $this->configurable = ['host', 'port', 'username', 'password', 'timeout', 'root', 'privateKey', 'publicKey', 'permPrivate', 'permPublic', 'directoryPerm', 'NetSftpConnection'];
	...
	protected function listDirectoryContents($directory, $recursive = true)
	{
		...
		return !isset($result[1]) ? $result[0] : \array_merge(...$result);
	}
