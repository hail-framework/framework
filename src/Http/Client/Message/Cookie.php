...
final class Cookie
{
    ...
    {
        return null !== $this->expires and $this->expires < new \DateTime();
    }
    ...
    {
        if (null !== $value && \preg_match('/[^\x21\x23-\x2B\x2D-\x3A\x3C-\x5B\x5D-\x7E]/', $value)) {
