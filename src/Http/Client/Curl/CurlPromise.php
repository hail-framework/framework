 ...
 */
class CurlPromise extends Promise
{
    /**
     * Shared promise core.
     *
     ...
     *
     * @return PromiseInterface Always returns a new promise which is resolved with value of the executed
     ...
     *
     * @throws \Psr\Http\Client\ClientException The rejection reason
     */
