...
use Hail\Excel\Reader\Exception\SharedStringNotFoundException;
 ...
 *
 * @package Hail\Excel\Reader\XLSX\Helper\SharedStringsCaching
 */
class FileBasedStrategy implements CachingStrategyInterface
{
	...
	/** @var \Hail\Excel\Common\Helper\FileSystemHelper Helper to perform file system operations */
	...
	public function getStringAtIndex($sharedStringIndex)
	{
		...
		if ($this->inMemoryTempFilePath !== $tempFilePath) {
			...
			$this->inMemoryTempFileContents = explode(PHP_EOL, $this->fileSystemHelper->file_get_contents($tempFilePath));
