...
class StyleHelper
{
     ...
     *
     * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on the "numFmts" node
     * @return void
     */
     ...
     *
     * @param \Hail\Excel\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on the "cellXfs" node
     * @return void
     */
