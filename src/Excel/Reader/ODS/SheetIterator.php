...
class SheetIterator implements IteratorInterface
{
    ...
    /** @var \Hail\Excel\Common\Escaper\ODS Used to unescape XML data */
    protected $escaper;
     ...
     *
     * @return void
     * @throws \Hail\Excel\Common\Exception\IOException If unable to open the XML file containing sheets' data
     */
     ...
     *
     * @return \Hail\Excel\Reader\ODS\Sheet
     */
