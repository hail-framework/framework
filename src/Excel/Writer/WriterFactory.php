...
class WriterFactory
{
    ...
    private static function auto(string $file, string $tempPath = null)
    {
        if ($tempPath === null) {
            $tempPath = \storage_path('excel');
        }
	...
	public static function browser(string $file, string $tempPath = null)
	{
	...
	public static function file(string $file, string $tempPath = null)
	{
		$writer = self::auto($file, $tempPath);
