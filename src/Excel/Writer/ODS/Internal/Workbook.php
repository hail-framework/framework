...
namespace Hail\Excel\Writer\ODS\Internal;

use Hail\Excel\Writer\Common\Internal\AbstractWorkbook;
use Hail\Excel\Writer\ODS\Helper\FileSystemHelper;
use Hail\Excel\Writer\ODS\Helper\StyleHelper;
 ...
 *
 * @package Hail\Excel\Writer\ODS\Internal
 */
class Workbook extends AbstractWorkbook
{
    ...
    /** @var \Hail\Excel\Writer\ODS\Helper\FileSystemHelper Helper to perform file system operations */
    protected $fileSystemHelper;

    /** @var \Hail\Excel\Writer\ODS\Helper\StyleHelper Helper to apply styles */
    ...
    /**
     * @return \Hail\Excel\Writer\ODS\Helper\StyleHelper Helper to apply styles to ODS files
     */
