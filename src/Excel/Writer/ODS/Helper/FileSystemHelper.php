...
namespace Hail\Excel\Writer\ODS\Helper;

use Hail\Excel\Writer\Common\Helper\ZipHelper;
use Hail\Excel\Writer\ODS\Internal\Worksheet;
 ...
 *
 * @package Hail\Excel\Writer\ODS\Helper
 */
class FileSystemHelper extends \Hail\Excel\Common\Helper\FileSystemHelper
{
     ...
     *
     * @return FileSystemHelper
     * @throws \Hail\Excel\Common\Exception\IOException If unable to create the folder or the "manifest.xml" file
     */
