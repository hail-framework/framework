...
namespace Hail\Excel\Writer\Common\Helper;

/**
 * Class AbstractStyleHelper
 * This class provides helper functions to manage styles
 *
 * @package Hail\Excel\Writer\Common\Helper
 */
abstract class AbstractStyleHelper
{
    ...
    /**
     * @param \Hail\Excel\Writer\Style\Style $defaultStyle
     */
     ...
     *
     * @param \Hail\Excel\Writer\Style\Style $style The style to be registered
     * @return \Hail\Excel\Writer\Style\Style The registered style, updated with an internal ID.
     */
     ...
     *
     * @param \Hail\Excel\Writer\Style\Style $style
     * @return bool
     */
     ...
     * @return \Hail\Excel\Writer\Style\Style
     */
    ...
    /**
     * @return \Hail\Excel\Writer\Style\Style[] List of registered styles
     */
     ...
     *
     * @return \Hail\Excel\Writer\Style\Style Default style
     */
     ...
     *
     * @param \Hail\Excel\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \Hail\Excel\Writer\Style\Style The updated style
     */
     ...
     * @param \Hail\Excel\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \Hail\Excel\Writer\Style\Style The eventually updated style
     */
