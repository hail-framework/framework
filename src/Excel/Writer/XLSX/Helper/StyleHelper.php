...
use Hail\Excel\Writer\Common\Helper\AbstractStyleHelper;
use Hail\Excel\Writer\Style\Color;
use Hail\Excel\Writer\Style\Style;
...
EOD;
    ...
    protected function getFontsSectionContent()
    {
        ...
        /** @var \Hail\Excel\Writer\Style\Style $style */
        ...
        foreach ($this->registeredBorders as $styleId) {
            ...
            foreach ($sortOrder as $partName) {
                if ($border->hasPart($partName)) {
                    /** @var $part \Hail\Excel\Writer\Style\BorderPart */
