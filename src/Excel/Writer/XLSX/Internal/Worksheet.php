...
namespace Hail\Excel\Writer\XLSX\Internal;
 ...
 *
 * @package Hail\Excel\Writer\XLSX\Internal
 */
class Worksheet implements WorksheetInterface
{
	 ...
	 *
	 * @see https://support.office.com/en-us/article/Excel-specifications-and-limits-16c69c74-3d6a-4aaf-ba35-e6eb276e8eaa
	 *      [Excel 2007]
	 * @see https://support.office.com/en-us/article/Excel-specifications-and-limits-1672b34d-7043-467e-8e27-269d656771c3
	 *      [Excel 2010]
	 * @see https://support.office.com/en-us/article/Excel-specifications-and-limits-ca36e2dc-1f09-4620-b726-67c00b05040f
	 *      [Excel 2013/2016]
	 */
...
EOD;
	...
	/** @var \Hail\Excel\Writer\Common\Sheet The "external" sheet */
	protected $externalSheet;

	/** @var string Path to the XML file that will contain the sheet data */
	protected $worksheetFilePath;

	/** @var \Hail\Excel\Writer\XLSX\Helper\SharedStringsHelper Helper to write shared strings */
	protected $sharedStringsHelper;

	/** @var \Hail\Excel\Writer\XLSX\Helper\StyleHelper Helper to work with styles */
	protected $styleHelper;

	/** @var bool Whether inline or shared strings should be used */
	protected $shouldUseInlineStrings;

	/** @var \Hail\Excel\Common\Escaper\XLSX Strings escaper */
	...
	/**
	 * @param \Hail\Excel\Writer\Common\Sheet                    $externalSheet          The associated "external"
	 *                                                                                   sheet
	 * @param string                                             $worksheetFilesFolder   Temporary folder where the
	 *                                                                                   files to create the XLSX will
	 *                                                                                   be stored
	 * @param \Hail\Excel\Writer\XLSX\Helper\SharedStringsHelper $sharedStringsHelper    Helper for shared strings
	 * @param \Hail\Excel\Writer\XLSX\Helper\StyleHelper         Helper                  to work with styles
	 * @param bool                                               $shouldUseInlineStrings Whether inline or shared
	 *                                                                                   strings should be used
	 *
	 * @throws \Hail\Excel\Common\Exception\IOException If the sheet data file cannot be opened for writing
	 */
	public function __construct($externalSheet, $worksheetFilesFolder, $sharedStringsHelper, $styleHelper, $shouldUseInlineStrings)
	{
		...
		$this->stringsEscaper = \Hail\Excel\Common\Escaper\XLSX::getInstance();
    ...
    protected function getCellXML($rowIndex, $cellNumber, $cellValue, $styleId)
	{
		...
		if (CellHelper::isNonEmptyString($cellValue)) {
			...
			$cellXML .= ' t="b"><v>' . ((int) $cellValue) . '</v></c>';
