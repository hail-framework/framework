...
use Hail\Excel\Writer\Common\Internal\AbstractWorkbook;
use Hail\Excel\Writer\XLSX\Helper\FileSystemHelper;
use Hail\Excel\Writer\XLSX\Helper\SharedStringsHelper;
use Hail\Excel\Writer\XLSX\Helper\StyleHelper;
use Hail\Excel\Writer\Common\Sheet;
...
class Workbook extends AbstractWorkbook
{
    ...
    /** @var \Hail\Excel\Writer\XLSX\Helper\FileSystemHelper Helper to perform file system operations */
    protected $fileSystemHelper;

    /** @var \Hail\Excel\Writer\XLSX\Helper\SharedStringsHelper Helper to write shared strings */
    protected $sharedStringsHelper;

    /** @var \Hail\Excel\Writer\XLSX\Helper\StyleHelper Helper to apply styles */
     ...
     * @param \Hail\Excel\Writer\Style\Style $defaultRowStyle
     * @throws \Hail\Excel\Common\Exception\IOException If unable to create at least one of the base folders
     */
    ...
    /**
     * @return \Hail\Excel\Writer\XLSX\Helper\StyleHelper Helper to apply styles to XLSX files
     */
     ...
     * @throws \Hail\Excel\Common\Exception\IOException If unable to open the sheet for writing
     */
