...
use Hail\Excel\Common\Exception\ExcelException;
use Hail\Excel\Common\Helper\FileSystemHelper;
use Hail\Excel\Writer\Exception\WriterAlreadyOpenedException;
use Hail\Excel\Writer\Exception\WriterNotOpenedException;
use Hail\Excel\Writer\Style\StyleBuilder;
...
abstract class AbstractWriter implements WriterInterface
{
	 ...
	 *
	 * @return void
	 * @throws \Hail\Excel\Common\Exception\IOException If the writer cannot be opened
	 */
	 ...
	 *
	 * @return AbstractWriter
	 * @throws \Hail\Excel\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
	 */
	...
	public function openToBrowser($outputFileName)
	{
		...
		header('Content-Disposition: attachment; filename="' . $this->outputFilePath . '"');
	 ...
	 *
	 * @return void
	 * @throws \Hail\Excel\Common\Exception\IOException If the pointer is not available
	 */
	 ...
	 *
	 * @return void
	 * @throws \Hail\Excel\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened and must not be.
	 */
	 ...
	 * @api
	 * @return AbstractWriter
	 * @throws \Hail\Excel\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
	 * @throws \Hail\Excel\Common\Exception\IOException If unable to write data
	 * @throws \Hail\Excel\Common\Exception\ExcelException If anything else goes wrong while writing data
	 */
	 ...
	 *
	 * @return AbstractWriter
	 * @throws \Hail\Excel\Common\Exception\InvalidArgumentException If the input param is not valid
	 * @throws \Hail\Excel\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
	 * @throws \Hail\Excel\Common\Exception\IOException If unable to write data
	 */
